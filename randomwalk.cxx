...
void conditions(int N, int* rx, int* ry);
void pusher(colloid* c, const int N, const int* rx, const int* ry);
void statistics(const colloid* const c, const int N, double& var, double& meanx, double& meany);
